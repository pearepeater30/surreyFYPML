...
def create_training_data():
    ...
    for entry in list:
        ...
        for img in os.listdir(path):
            try:
                ...
                img_array = cv2.imdecode(numpyarray, cv2.IMREAD_COLOR)
    ...
    X_train = features.reshape(features.shape[0], IMG_HEIGHT, IMG_LENGTH, 3)
...
def create_separate_testing_data():
    ...
    X_separate_test = test_features.reshape(test_features.shape[0], IMG_HEIGHT, IMG_LENGTH, 3)
